export type ThemeId =
  ...
  // The original 6-palette system (calm-1/2, bright-1/2, acid-1/2), kept
  // alongside the 20 above rather than replaced. Each one only ever shipped
  // at a single toxicity level — the other two are generated by holding its
  // hue fixed and applying the same calm/bright/acid saturation+lightness
  // formula the 20 use, so they fit the same theme x toxicity model. The
  // exact original hex is preserved at the level it already shipped at.
  | 'sage-terracotta' | 'periwinkle-mauve' | 'blue-pink' | 'orange-violet' | 'electro-lime-fuchsia' | 'neon-yellow-cyan';
...
export const THEME_PAIRS: Record<ThemeId, Record<Toxicity, Pair>> = {
  ...
  // Original 6-palette system — hue-preserving calm/bright/acid generated
  // from whichever single level each one originally shipped at (kept
  // pixel-exact at that level; see the ThemeId comment above).
  'sage-terracotta': {
    calm: { lime: '#7a9b8e', coral: '#a67c6d' },
    bright: { lime: '#43EAA8', coral: '#EA6F43' },
    acid: { lime: '#24FFA9', coral: '#FF5D24' },
  },
  'periwinkle-mauve': {
    calm: { lime: '#8a93c2', coral: '#b891a6' },
    bright: { lime: '#435EEA', coral: '#EA439D' },
    acid: { lime: '#2447FF', coral: '#FF249A' },
  },
  'blue-pink': {
    calm: { lime: '#7F97C3', coral: '#C37F92' },
    bright: { lime: '#4d8dff', coral: '#ff5c8a' },
    acid: { lime: '#2473FF', coral: '#FF2462' },
  },
  'orange-violet': {
    calm: { lime: '#C39A7F', coral: '#9E7FC3' },
    bright: { lime: '#ff8a3d', coral: '#9b5de5' },
    acid: { lime: '#FF7B24', coral: '#8824FF' },
  },
  'electro-lime-fuchsia': {
    calm: { lime: '#B2C889', coral: '#C37FA9' },
    bright: { lime: '#B5EC51', coral: '#EA43AB' },
    acid: { lime: '#b6ff2e', coral: '#ff2fb0' },
  },
  'neon-yellow-cyan': {
    calm: { lime: '#C4C889', coral: '#7FBCC3' },
    bright: { lime: '#E3EC51', coral: '#43D9EA' },
    acid: { lime: '#f4ff2e', coral: '#00e5ff' },
  },
};
